...
public class HCCP_Multi_Freq {
	...
	public static void main(String[] args) {
				...
				chChance += Configuration.getDoubleConfig("chChanceIncrement"))
		{
			...
			for (double subOptimal=Configuration.getDoubleConfig("subFrom"); 
					subOptimal < Configuration.getDoubleConfig("subTo"); 
					subOptimal += Configuration.getDoubleConfig("subIncrement"))
			{
				for ( double thisFreq = Configuration.getDoubleConfig("freqFrom");
						thisFreq < Configuration.getDoubleConfig("freqFrom") ; 
						thisFreq += Configuration.getDoubleConfig("freqIncrement"))
				{
