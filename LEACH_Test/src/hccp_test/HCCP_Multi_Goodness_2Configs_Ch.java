...
public class HCCP_Multi_Goodness_2Configs_Ch {
	...
	public static void main(String[] args) {
		...
		{
			for (double j = Configuration.getDoubleConfig("chChanceFrom");
					j < Configuration.getDoubleConfig("chChanceTo");
					j += Configuration.getDoubleConfig("chChanceIncrement"))
			{
